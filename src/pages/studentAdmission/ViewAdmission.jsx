                ...
                <Row>
                    <Col md={12} style={{ padding: '15px 5px 5px 15px' }}>
                        <CustomTable
                            ...
                            dataSource={arr}
                            size="small"
                            style={{ backgroundColor: 'black', boxShadow: '20px 20px 20px grey' }}
                        />
                    </Col>
                    <Col md={12} style={{ padding: '15px 15px 5px 5px' }}>
                        <CustomTable
                            ...
                            dataSource={arr1}
                            size="small"
                            style={{ backgroundColor: 'black', boxShadow: '20px px 20px grey' }}
                        />
                    </Col>
                </Row>
                <Row>
                    <Col md={8} style={{ padding: '5px 5px 5px 15px' }}>
                        <CustomTable
                            ...
                            dataSource={arr2}
                            size="small"
                            style={{ backgroundColor: 'black', boxShadow: '20px 5px 20px grey' }}
                        />
                    </Col>
